...
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"Since the dataset is huge, the profiling has been done on the sample dataset."}</p><br>', unsafe_allow_html=True)
...
df = pd.read_csv(X_test_file).sample(n=5000)
