...
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"4. Road Category "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"5. Traffic Regime "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"6. Nr Of Traffic Lanes "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"7. Accident Situation "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"8. Struck With Fixed Object "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"9. Struck With Moving Object "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"10.Initial Shock Point "}</p>', unsafe_allow_html=True)
st.markdown(f'<p align="justify" font-family: "Times New Roman" style="color:#000000;"><br>{"11.Intersection Type "}</p>', unsafe_allow_html=True)
